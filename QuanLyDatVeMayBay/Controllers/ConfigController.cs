...
namespace QuanLyDatVeMayBay.Controllers
{
    ...
    public class ConfigController : ControllerBase
    {
        ...
        public async Task<IActionResult> ConvertHangBayToJson()
        {
            await _convertDBToJsonServices.ConvertHangBayToJson();
            return Ok(new { message = "Convert Hãng Bay to JSON thành công!" });
        }
        ...
        public async Task<IActionResult> ConvertSanBayToJson()
        {
            ...
            return Ok(new { message = "Convert Sân Bay to JSON thành công!" });
        }
        [HttpGet("redis-test")]
